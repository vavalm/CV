...
$menu = array(
    'title' => 'CV of Valentin Maupin - IT student in IMT Lille Douai',
    'description' => 'Valentin Maupin is a french engineering student in IT at IMT Lille Douai. Discover his CV.',
    ...
    'description' => 'About',
    'education' => 'Education',
    'profexp' => 'Professional Experiences',
    'skills' => 'Skills',
    'qualities' => 'Qualities',
    'hobbies' => 'Hobbies',
    'contact' => 'Contact',
...
$tag = array(
    'meta-description' => '<meta name="description" content="Valentin Maupin is a french engineering student in IMT Lille Douai. Discover his CV." />',
    'og-title' => '<meta property="og:title" content="CV of Valentin Maupin - french engineering student in IMT Lille Douai" />',
    'og-lang' => '<meta property="og:locale" content="en" />',
    'og-description' => '<meta property="og:udescription" content="Valentin Maupin is a french engineering student in IT at IMT Lille Douai. Discover his CV." />',
);
...
$company = array(
    'title' => 'Companies mentioned above',
    'partpol' => 'Consulting company',
    'erd' => 'Specialized in ereputation management, social media and community management',
...
$education = array(
    'bac' => '<span class="arrow"> </span>
                                        ...
                                        <h3>Baccalauréat scientifique with honours (+IT option) at Lycée Cassini</h3>
    ...
    'prepa' => '<span class="arrow"></span>
                                        ...
                                        <h3>2 years of preparation for the engineering cycle</h3>
...
$skills = array(
    ...
    'flint' => '<span class="arrow"></span>
                                        <div class="date">Summer 2014 and 2015 </div>
                                        <h3>Summer job at Flint Group</h3>
                                        <h4>60600 Clermont de l’Oise, France<br>Company of ink production</h4>
                                        <p>Summer job as production worker inks in order to pay my studies. Filled machines with chemical products.</p>',
    'decathlon' => '<span class="arrow"></span>
                                        <div class="date">2014: Feb-March </div>
    ...
    'manorga' => '                             <span class="arrow"></span>
                                        ...
                                        <h3>IT internship at Manorga (Roubaix, France)</h3>
    ...
    'erd' => '<span class="arrow"></span>
                                        <div class="date">2016: Feb-May</div>
                                        <h3>Marketing Internship at EReputationDefender (Creil, France)</h3>
                                        <h4>60180 Nogent-sur-Oise, France<br>
    ...
    'dev' => 'Programming Java + Java EE & C',
    'linux' => 'Linux (Debian, Archlinux, Ubuntu)',
    'srv' => 'Linux server administration',
    'windows' => 'Windows',
    'js' => 'JavaScript',
);
...
$contact = array(
    ...
    'name' => 'Maupin',
    'position' => 'IT engineer student in IMT Lille Douai (France)',
    'address' => 'Reeflex, 59650 Villeneuve d&apos;Ascq, France',
    'tel' => '+33 662 956 844',
    'email' => 'valentin@maupin.eu',
    'copy' => '© 2016 - All right reserved',
    'mentions' => 'Legal policies',
    'mentionsLink' => 'mentionslegales-en.html',
);
