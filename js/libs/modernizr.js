...
!function (e, t, n) {
    ...
    function s() {
        ...
        for (var f in x)if (x.hasOwnProperty(f)) {
            if (e = [], t = x[f], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))for (n = 0; n < t.options.aliases.length; n++)e.push(t.options.aliases[n].toLowerCase());
    ...
    function l(e, n, r, s) {
        var o, a, f, l, u = "modernizr", p = i("div"), c = d();
        if (parseInt(r, 10))for (; r--;)f = i("div"), f.id = s ? s[r] : u + (r + 1), p.appendChild(f);
    ...
    function g(e, t, s, o) {
        ...
        for (c = e.length, p = 0; c > p; p++)if (g = e[p], h = j.style[g], a(g, "-") && (g = f(g)), j.style[g] !== n) {
    ...
    function h(e, t, n, s, o) {
        var i = e.charAt(0).toUpperCase() + e.slice(1), a = (e + " " + z.join(i + " ") + i).split(" ");
    ...
    var C = "svg" === w.nodeName.toLowerCase(), S = b._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];
    ...
    var T = "CSS" in e && "supports" in e.CSS, _ = "supportsCSS" in e;
    Modernizr.addTest("supports", T || _);
    var k = b.testStyles = l, P = "Moz O ms Webkit", z = b._config.usePrefixes ? P.split(" ") : [];
    b._cssomPrefixes = z;
    ...
    Modernizr.addTest("textshadow", A("textShadow", "1px 1px")), b.testAllProps = h, b.testAllProps = v, Modernizr.addTest("cssanimations", v("animationName", "a", !0)), Modernizr.addTest("bgrepeatround", v("backgroundRepeat", "round")), Modernizr.addTest("bgrepeatspace", v("backgroundRepeat", "space")), Modernizr.addTest("boxshadow", v("boxShadow", "1px 1px", !0)), Modernizr.addTest("csstransforms", function () {
        ...
        var e = !!v("perspective", "1px", !0), t = Modernizr._config.usePrefixes;
